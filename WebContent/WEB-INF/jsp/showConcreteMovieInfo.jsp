...
<table width="100%" cellspacing="0" cellpadding="4">
		...
		<td align="left" width="70%"><c:out value="${sessionScope.movieInfo.movieTitle}" /></td>
		</tr>
		<tr>
		<td align="left"><c:out value="${movie_director}" /></td>
		<td align="left"><c:out value="${sessionScope.movieInfo.movieDirector}" /></td>
		</tr>
		<tr>
		<td align="left"><c:out value="${movie_released_year}" /></td>
		<td align="left"><c:out value="${sessionScope.movieInfo.movieReleasedYear}" /></td>
		</tr>
		<tr>
		<td align="left"><c:out value="${movie_rate}" /></td>
		<td align="left"><c:out value="${sessionScope.movieInfo.movieAVGRate}" /></td>
		</tr>
...
<table cellspacing="2" border="1" cellpadding="5" bordercolor="gray">
		...
		<fmt:formatDate pattern="dd-MM-yyyy" value="${rates.rateDate}" dateStyle="short" var="date"/>
					<c:if test="${count >= concreteMovieFirstRow && count < concreteMovieLastRow}">
						<tr>
							<td align="center" width="200"><c:out value="${date}"></c:out></td>
							<fmt:setLocale value="${sessionScope.local}" />
							<td align="center" width="75"><c:out value="${rates.rateValue}"></c:out></td>
							<td align="center" width="200"><c:out value="${rates.userFirstName}"></c:out>
							<c:out value="${rates.userLastName}"></c:out></td>
							<td align="center" width="100"><c:out value="${rates.rateComment}"></c:out></td>
						</tr>
					</c:if>
	...
	<form action="Servlet" method="post">
		...
		<h3>
		<c:out value="${page } ${sessionScope.concreteMovieNumberOfCurrentPage } ${from } ${sessionScope.concreteMovieNumberOfPages}" />
		</h3>
