			...
			<c:if
				...
				<tr>
					<td align="center" width="75">
						<c:out value="${movies.movieID}">
						</c:out>
					</td>
					<td align="center" width="200">
						<a href="Servlet?command=concreteMovieInfo&movie_id=${movies.movieID}">${movies.movieTitle}
						</a>
					</td>
					<td align="center" width="100">
						<c:out value="${movies.movieDirector}">
						</c:out>
					</td>
					<td align="center" width="100">
						<c:out value="${movies.movieReleasedYear}">
						</c:out>
					</td>
					<td align="center" width="75">
						<c:out value="${movies.movieAVGRate}">
						</c:out>
					</td>
				</tr>
			</c:if>
