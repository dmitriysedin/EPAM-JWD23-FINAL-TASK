...
<body>
 <fmt:setLocale value="${sessionScope.local}" />
    ...
    <fmt:message bundle="${loc}" key="locale.addNewRate.welcome_message" var="welcome_message" />
    <fmt:message bundle="${loc}" key="locale.addNewRate.add_rate" var="add_rate" />
    <fmt:message bundle="${loc}" key="locale.addNewRate.enter_add_rate" var="enter_add_rate" />
    <fmt:message bundle="${loc}" key="locale.addNewRate.add_comment" var="add_comment" />
   	<fmt:message bundle="${loc}" key="locale.default.go_to_home_page" var="home" />
   	<fmt:message bundle="${loc}" key="locale.addNewRate.rate_pattern" var="rate_pattern" />
   	<fmt:message bundle="${loc}" key="locale.default.go_to_home_page" var="home" />
...
<h1>${welcome_message}</h1>
	...
	<form action="Servlet" method="post">
		...
		<tr>
		<td align="right" width="200" title="${rate_pattern}">${add_rate} </td>
		<td><input type="number" size="50" name="rate_value" min="1" max="10" required /></td>
		</tr>
		<tr>
