...
<body>
	...
	<fmt:message bundle="${loc}" key="locale.login.welcome_message"
		var="welcom_message" />
	...
	<fmt:message bundle="${loc}" key="locale.default.enter_message"
		var="enter_message" />
	<fmt:message bundle="${loc}" key="locale.default.registration_message"
		var="registration_message" />
	<fmt:message bundle="${loc}" key="locale.login.login_pattern"
		var="login_pattern" />
	<fmt:message bundle="${loc}" key="locale.login.pass_pattern"
		var="pass_pattern" />
		<fmt:message bundle="${loc}" key="locale.login.wrong_params"
		var="login_wrong_params" />
